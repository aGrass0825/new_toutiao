class DefaultConfig(object):
    ...
    SQLALCHEMY_ECHO = True  # 当为True时sql原生语句会在终端显示
    ...
    # 七牛云身份信息
    QINIU_ACCESS_KEY = '8TQBS_eRB6N9OIasgSQ752DEYEQiF7v1BnA-hTOr'
    QINIU_SECRET_KEY = 'UVjtVHhMNhDbdX7vZ16QjAVWl7Y7gEn9Aw71BhQS'
    QINIU_BUCKET_NAME = 'wh20toutiao'
    QINIU_DOMAIN = 'http://q7rfe81k0.bkt.clouddn.com/'
